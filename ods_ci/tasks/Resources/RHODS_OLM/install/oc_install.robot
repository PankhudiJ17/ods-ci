...
Install Connectivity Link Operator Via Cli
    ...
    IF    '${arch_type}' == 's390x' or '${arch_type}' == 'ppc64le'
        Log    Skipping Red Hat Connectivity Link Operator installation for s390x and ppc64le architecture    console=yes
        Log    Skipping Authorino Operator installation for s390x and ppc64le architecture    console=yes
        RETURN
    END
